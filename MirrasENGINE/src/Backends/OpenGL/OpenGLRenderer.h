...
namespace mirras
{
    ...
    public:
        ...
        void setPixelOutputData(int32 value);
        ...
        void drawTexture(const Texture& texture, const rect4f& texSampleArea, const glm::vec3& targetTopLeft, glm::vec2 targetSize,
        ...
        void drawText(std::u32string_view text, const Font& font, const glm::vec3& topLeftPos,
                      float fontSize,const glm::vec4& color, float kerning, float lineSpacing);

        void drawText(std::u32string_view text, const Font& font, glm::vec2 topLeftPos,
                      float fontSize, const glm::vec4& color, float kerning, float lineSpacing);
    };
} // namespace mirras
