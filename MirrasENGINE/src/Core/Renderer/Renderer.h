...
namespace mirras
{
    ...
    public:
        ...
        static void drawText(std::u32string_view text, const Font& font, const glm::vec3& topLeft, float fontSize = 40.f,
                             const glm::vec4& color = glm::vec4{1.f}, float kerning = 0.f, float lineSpacing = 0.f);

        static void drawText(std::u32string_view text, const Font& font, glm::vec2 topLeft, float fontSize = 40.f,
                            const glm::vec4& color = glm::vec4{1.f}, float kerning = 0.f, float lineSpacing = 0.f);
