...
namespace mirras
{
    ...
    public:
        ...
        static void drawRectangleLines(const glm::vec3& topLeft, glm::vec2 size, const glm::vec4& color);
        static void drawRectangleLines(glm::vec2 topLeft, glm::vec2 size, const glm::vec4& color);
