...
PFD_INLINE opt operator |(opt a, opt b) { return opt(uint8_t(a) | uint8_t(b)); }
PFD_INLINE bool operator &(opt a, opt b) { return bool(uint8_t(a) & uint8_t(b)); }
...
public:
    ...
    bool kill() const;
    bool is_active() const { return m_async->m_running; };
...
public:
    ...
    void open(std::string const &title,
              std::string const &default_path = "",
              std::vector<std::string> const &filters = { "All Files", "*" },
              opt options = opt::none);
...
public:
    ...
    void save(std::string const &title,
              std::string const &default_path = "",
              std::vector<std::string> const &filters = { "All Files", "*" },
              opt options = opt::none);
...
public:
    ...
    void select(std::string const &title,
                std::string const &default_path = "",
                opt options = opt::none);
...
#if _WIN32
static PFD_INLINE HWND get_window_handle(){
    // Get current Window
	//
...
PFD_INLINE internal::file_dialog::file_dialog(type in_type,
            ...
            opt options /* = opt::none */)
{
    launch(in_type, title, default_path, filters, options);
}


PFD_INLINE void internal::file_dialog::launch(type in_type,
            std::string const &title,
            std::string const &default_path /* = "" */,
            std::vector<std::string> const &filters /* = {} */,
            opt options /* = opt::none */)
...
PFD_INLINE open_file::open_file(std::string const &title,
                            ...
                            opt options /* = opt::none */)
{
    open(title, default_path, filters, options);
}
...
PFD_INLINE open_file::open_file(std::string const &title,
                            ...
                            bool allow_multiselect)
{
    open(title, default_path, filters, (allow_multiselect ? opt::multiselect : opt::none));
}

PFD_INLINE void open_file::open(std::string const &title,
                            std::string const &default_path /* = "" */,
                            std::vector<std::string> const &filters /* = { "All Files", "*" } */,
                            opt options /* = opt::none */)
{
    launch(type::open, title, default_path, filters, options);
}
...
PFD_INLINE save_file::save_file(std::string const &title,
                            ...
                            opt options /* = opt::none */)
{
    save(title, default_path, filters, options);
}
...
PFD_INLINE save_file::save_file(std::string const &title,
                            ...
                            bool confirm_overwrite)
{
    save(title, default_path, filters, (confirm_overwrite ? opt::none : opt::force_overwrite));
}

PFD_INLINE void save_file::save(std::string const &title,
                            std::string const &default_path /* = "" */,
                            std::vector<std::string> const &filters /* = { "All Files", "*" } */,
                            opt options /* = opt::none */)
{
    launch(type::save, title, default_path, filters, options);
}
...
PFD_INLINE select_folder::select_folder(std::string const &title,
                                    ...
                                    opt options /* = opt::none */)
{
    select(title, default_path, options);
}

PFD_INLINE void select_folder::select(std::string const &title,
                                    std::string const &default_path /* = "" */,
                                    opt options /* = opt::none */)
{
    launch(type::folder, title, default_path, {}, options);
}
