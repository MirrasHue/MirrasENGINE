...
//----------------------------------------------------------------------------------
// In order to use spdlog in raudio.c, we would have to convert it to a C++ file (it's using printf now)
//----------------------------------------------------------------------------------
...
// NOTE: Actual structs are defined internally in raudio.c
